      ...
      <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-gray-400 mt-3">
            Connecting farmers and buyers across Bangladesh with fresh, trusted agricultural products.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link to={'/all-crops'} className="hover:text-green-400" >All Crops</Link></li>
            <li><Link to={'/profile'} className="hover:text-green-400" >My Profile</Link></li>
            <li><Link to={'/add-crops'} className="hover:text-green-400" >Home</Link></li>
          </ul>
        </div>
