  ...
  return (
    <div>
      {!myInterests.length ? (
        ...
        <div>
          <div>
            <h1 className="text-4xl text-center font-bold text-green-700 border-b-2">
              My Interests
            </h1>
          </div>
                ...
                {myInterests.map((interest) => (
                  <tr>
                    ...
                    <td className=" hidden md:block">
                      {interest.ownerName}
                      <br />
                      <span>{interest.ownerEmail}</span>
                    </td>
                    <td>
                      {interest.quantity}
                      <br />
                      <span>total:{interest.totalPrice} ৳</span>
                    </td>
                    <td className="hidden md:block ">{interest.message}</td>
                    <th>
